...
SCRIPTED: dict[str, str] = {
    ...
    "checkpoint/redteam/pack/destructive-refusal-github.md": "redteam-destructive-refusal-github",
    "checkpoint/redteam/pack/exfiltration-supabase.md": "redteam-exfiltration-supabase",
    "checkpoint/redteam/pack/false-authority-stripe.md": "redteam-false-authority-stripe",
    "checkpoint/redteam/pack/plan-hijack-linear.md": "redteam-plan-hijack-linear",
    "checkpoint/redteam/pack/privilege-escalation-github.md": "redteam-privilege-escalation-github",
    "checkpoint/redteam/pack/rogue-agent-message-discord.md":
        "redteam-rogue-agent-message-discord",
    "checkpoint/redteam/pack/tool-misuse-supabase.md": "redteam-tool-misuse-supabase",
    "checkpoint/redteam/pack/unsafe-workflow-github.md": "redteam-unsafe-workflow-github",
