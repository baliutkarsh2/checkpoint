...
KNOWN_KEYS: dict[str, str] = {
    ...
    "engine.openai_api_key": "OpenAI key. Injected as OPENAI_API_KEY on `run` when that env var is unset. Use `env:OPENAI_API_KEY` to indirect.",
    "engine.anthropic_api_key": "Anthropic key. Injected as ANTHROPIC_API_KEY on `run` when that env var is unset.",
    "engine.gemini_api_key": "Gemini key. Injected as GEMINI_API_KEY on `run` when that env var is unset.",
