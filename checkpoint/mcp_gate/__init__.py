...
So a coding agent — any MCP client — can test the very agent it is building,
inline, during development: list scenarios, run one, or gate a whole directory,
as MCP tool calls. The tool *logic* lives in plain functions in
