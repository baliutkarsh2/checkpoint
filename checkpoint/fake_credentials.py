...
This module is the ONE canonical source of these seven constants. Every twin,
the proxy, the runner, the MCP servers, and the tests import them from here —
never hardcode a token literal anywhere else.
"""
