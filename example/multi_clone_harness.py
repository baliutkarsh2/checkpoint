...
CHECKPOINT_OUT = Path(os.environ.get("CHECKPOINT_OUT_DIR", "/tmp/checkpoint-out"))

GH_TOKEN = os.environ.get("GITHUB_TOKEN", "ghp_AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTt")
SL_TOKEN = os.environ.get("SLACK_TOKEN", "xoxb-123456789012-234567890123-AbCdEfGhIjKlMnOpQrStUvWx")
ST_TOKEN = os.environ.get("STRIPE_API_KEY", "sk_live_51Abc123DefGhiJklMnoPqrStUvWxYz0123456789")
...
def main():
    ...
    try:
        ...
        (CHECKPOINT_OUT / "summary.json").write_text(json.dumps(summary, indent=2))
    except Exception:
        pass
